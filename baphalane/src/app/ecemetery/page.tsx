...
export default function ECemeteryPage() {
  ...
  const formatDate = (date: string | Date | null) => {
    ...
    return d.getFullYear().toString(); // Just year for burial
  };
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      >
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 py-7 text-white">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            {results.map((grave) => (
              ...
              <div
                key={grave.public_id}
                onClick={() => router.push(`/graves/${grave.public_id}`)}
