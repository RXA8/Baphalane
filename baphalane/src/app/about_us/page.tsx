      ...
      <div className="relative bg-[url('/images/heritage-bg.jpg')] bg-cover bg-center py-16 px-4 md:px-20">
        <div className="bg-white bg-opacity-90 backdrop-blur-md rounded-lg shadow-lg p-8 md:p-12 max-w-5xl mx-auto">
          ...
          <section className="space-y-8 text-gray-800 text-lg">
            <div>
              <h2 className="text-2xl font-semibold text-gray-700 mb-2">Historical Challenges and Leadership Struggles</h2>
              <p>
            ...
            <div>
              <h2 className="text-2xl font-semibold text-gray-700 mb-2">Unemployment and Skills Development</h2>
              <p>
            ...
            <div>
              <h2 className="text-2xl font-semibold text-gray-700 mb-2">Land, Economic Growth, and Agro-Business</h2>
              <p>
